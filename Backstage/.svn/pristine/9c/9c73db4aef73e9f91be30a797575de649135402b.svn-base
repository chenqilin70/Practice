...
public class Product {
	...
	public String toString() {
		return "Product [name=" + name + ", brand=" + brand + ", seris=" + seris + ", description=" + description
				+ ", basicprice=" + basicprice + ", typeid=" + typeid + ", image=" + image + "]";
	}
	public Product(String name, String brand, String seris, String description, float basicprice, int typeid,
			String image) {
		super();
		this.name = name;
		this.brand = brand;
