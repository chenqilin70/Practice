    	...
    	<ul class="tab">
      	...
      	<div class="items">
            ...
            <tr>
          		...
          		<td><input type="text" name="site_name" value="DouPHP轻量级企业网站管理系统" size="80" class="inpMain" /></td>
         	</tr>
            <tr>
          		<td align="right">站点标题</td>
          		<td><input type="text" name="site_title" value="DouPHP轻量级企业网站管理系统" size="80" class="inpMain" /></td>
         	</tr>
            <tr>
          		<td align="right">站点关键字</td>
          		<td><input type="text" name="site_keywords" value="DouPHP,轻量级企业网站管理系统" size="80" class="inpMain" /></td>
         	</tr>
            <tr>
          		<td align="right">站点描述</td>
          		<td><input type="text" name="site_description" value="DouPHP,轻量级企业网站管理系统" size="80" class="inpMain" /></td>
         	</tr>
            <tr>
          		<td align="right">站点标志</td>
          		<td><input type="file" name="site_logo" size="18" /><a href="../theme/default/images/logo.gif" target="_blank"><img src="images/icon_yes.png"></a>                                </td>
        	</tr>
            <tr>
          		<td align="right">公司地址</td>
          		<td><input type="text" name="site_address" value="福建省漳州市芗城区" size="80" class="inpMain" /></td>
         	</tr>
            <tr>
          		<td align="right">是否关闭网站</td>
          		<td><label for="site_closed_0"><input type="radio" name="site_closed" id="site_closed_0" value="0" checked="checked">否</label>
           		<label for="site_closed_1">
            	<input type="radio" name="site_closed" id="site_closed_1" value="1">  是</label>
                </td>
         </tr>
                  <tr>
          ...
          <td>
                      <label for="rewrite_0">
            <input type="radio" name="rewrite" id="rewrite_0" value="0" checked="checked">
            否</label>
           <label for="rewrite_1">
          ...
          <td>
            ...
            否</label>
           <label for="sitemap_1">
            <input type="radio" name="sitemap" id="sitemap_1" value="1" checked="checked">
            是</label>
                                </td>
         </tr>
                  <tr>
          ...
          <td>
            ...
            否</label>
           <label for="captcha_1">
            <input type="radio" name="captcha" id="captcha_1" value="1" checked="checked">
            是</label>
                                </td>
         </tr>
                  <tr>
          ...
          <td>
           ...
           <label for="guestbook_check_chinese_1">
            <input type="radio" name="guestbook_check_chinese" id="guestbook_check_chinese_1" value="1" checked="checked">
            是</label>
        ...
        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
         <tr>
          ...
          <td>
            ...
            <input type="radio" name="mail_service" id="mail_service_0" value="0" checked="checked">
            系统内置Mail服务</label>
          ...
          <td>
            ...
            <input type="radio" name="mail_ssl" id="mail_ssl_0" value="0" checked="checked">
            否</label>
