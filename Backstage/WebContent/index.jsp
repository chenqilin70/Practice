...
<!-- dcHead 结束 --> <div id="dcLeft"><div id="menu">
 ...
 <div id="dcMain"> <!-- 当前位置 -->
<div id="urHere">电商后台 管理中心</div>  <div id="index" class="mainBox" style="padding-top:18px;height:auto!important;height:550px;min-height:550px;">
   <div id="douApi"></div>
      <div class="indexBox">
    <div class="boxTitle">杰仔专卖网-简介</div>
    <ul class="ipage">
     <a href="#">公司简介</a> 
   ...
   <div class="indexBox">
    ...
    <ul>
     <table width="100%" border="0" cellspacing="0" cellpadding="7" class="tableBasic">
      ...
      <tr>
       <td> 系统使用协议： </td>
       <td><a href="http://www.mycodes.net/license.jsp" target="_blank">http://www.mycodes.net/license.jsp</a><em>（您可以免费使用DouPHP（不限商用），但必须保留相关版权信息。）</em></td>
      </tr>
     </table>
    </ul>
   </div>
